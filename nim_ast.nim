...
import
  compiler/msgs, hashes, compiler/nversion, compiler/options, strutils, compiler/ropes, compiler/idents,
  intsets, compiler/idgen, nim_types
...
proc newIntTypeNode*(kind: TNodeKind, intVal: BiggestInt, typ: Type): PNode =
...
# proc linkTo*(t: Type, s: PSym): PType {.discardable.} =
#   t.sym = s
#   s.typ = t
#   result = t

# proc linkTo*(s: PSym, t: Type): PSym {.discardable.} =
#   t.sym = s
#   s.typ = t
#   result = s
...
proc newIdentNode*(ident: PIdent, info: TLineInfo = TLineInfo()): PNode =
...
proc newNodeIT*(kind: TNodeKind, info: TLineInfo, typ: Type): PNode =
  result = newNode(kind)
  result.info = info
  result.typ = typ
...
proc newProcNode*(kind: TNodeKind, info: TLineInfo, body: PNode,
                 ...
                 pragmas, exceptions = nim_ast.emptyNode): PNode =
